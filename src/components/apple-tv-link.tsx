    ...
    <div aria-hidden={!isVisible} className="h-11 flex-shrink-0">
      {isVisible ? (
        <div
          ...
          style={{
            width: expanded ? 120 : 44,
            transition: 'width 300ms cubic-bezier(0.34,1.2,0.64,1)',
          }}
        >
          {/* Monitor icon — tap to expand, tap again to collapse */}
          <button
            type="button"
            aria-label={expanded ? "Collapse" : "Watch on Apple TV"}
          ...
          {/* Apple TV label — fades in after pill expands, navigates on tap */}
          <a
            href={appleTvUrl}
            target="_blank"
            rel="noreferrer"
            ...
            style={{
              ...
              transition: expanded ? 'opacity 150ms ease-out 180ms' : 'opacity 80ms ease-in',
