  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <button
        ...
        disabled={isPending}
        className="rounded-full border border-black-700 px-4 py-2 text-xs uppercase tracking-[0.3em] text-black-100 transition hover:bg-black-800 disabled:opacity-60"
      >
