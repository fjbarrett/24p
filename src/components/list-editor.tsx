    ...
    <form className="space-y-4" onSubmit={handleSubmit}>
      ...
      <div className="rounded-2xl border border-black-700 bg-black-950 px-3 py-3 text-sm text-black-200 space-y-3">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="rounded-full border border-black-600 px-3 py-2 text-xs text-black-200 disabled:opacity-50"
          >
              ...
              <div key={share.userEmail} className="flex items-center justify-between text-xs text-black-200">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="rounded-full border border-black-700 px-2 py-1 text-[10px] text-black-300 disabled:opacity-50"
                  >
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className="rounded-full border border-black-600 px-4 py-2 text-sm text-black-200 disabled:opacity-50"
        >
          Cancel
        </button>
        <button
